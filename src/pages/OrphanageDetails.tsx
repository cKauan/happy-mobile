...
export default function OrphanageDetails() {
    ...
    const { id } = route.params as OrphanageId;
    useEffect(() => {
    ...
    function handleOpenGoogleMaps() {
        Linking.openURL(
            `https://www.google.com/maps/dir/?api1=1&destination=${orphanage?.latitude},${orphanage?.longitude}`
        );
    }
    if (!orphanage)
        return (
                ...
                <View style={styles.scheduleContainer}>
                    ...
                    {orphanage.open_on_weekends ? (
                        ...
                        >
                            ...
                            >
                                Não abrimos nos final de semana
                            </Text>
                        </View>
                    )}
                </View>
